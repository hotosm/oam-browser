                ...
                <li>
                  <Dropdown
                    ...
                    <ul className='drop__menu info-menu' role='menu'>
                      ...
                      <li><a className='drop__menu-item' href='#modal-feedback' title='Leave feedback' data-hook='dropdown:close' onClick={this.feedbackClickHandler}><span>Provide Feedback</span></a></li>
                    </ul>
                    <ul className='drop__menu info-menu' role='menu'>
